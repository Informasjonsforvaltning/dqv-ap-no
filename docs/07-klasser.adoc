...
|Beskrivelse|Brukes til å beskrive kvalitetsdeldimensjoner.
...
|Beskrivelse|Brukes til å beskrive kvalitetsdimensjoner.
|URI|dqv:Dimension
...
|Beskrivelse|Brukes til å beskrive Kvalitetssertifikater, dvs. noe som bekrefter en gitt kvalitet.
