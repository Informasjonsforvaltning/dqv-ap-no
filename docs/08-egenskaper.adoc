...
Egenskapene beskrevet her i denne spesifikasjonen, supplerer https://data.norge.no/specification/dcat-ap-no/#Datasett[egenskapene for Datasett beskrevet i DCAT-AP-NO &#x29C9;, window="_blank", role="ext-link"].
...
===== Datasett: har kvalitetsmerknad (dqv:hasQualityAnnotation) [[Datasett_harKvalitetsmerknad]]
...
|Beskrivelse|Brukes til å referere til en kvalitetsmerknad.
|Multiplisitet|0..n
|Kravnivå|Anbefalt
...
===== Datasett: har kvalitetsmåling (dqv:hasQualityMeasurement) [[Datasett_harKvalitetsmåling]]
...
|Beskrivelse|Brukes til å referere til en kvalitetsmåling.
|Multiplisitet|0..n
|Kravnivå|Anbefalt
|Eksempel a| [source]
----
...
=== Kvalitetsmerknad (dqv:QualityAnnotation) [[Kvalitetsmerknad_egenskaper]]

Tilsvarende gjelder også for <<Brukertilbakemelding>> og <<Kvalitetssertifikat>> som er subklasser av Kvalitetsnote (`dqv:QualityAnnotation`).

==== Obligatoriske egenskaper [[Kvalitetsmerknad_obligatoriske_egenskaper]]

===== Kvalitetsmerknad: er motivert av (oa:motivatedBy) [[Kvalitetsmerknad_erMotivertAv]]
...
==== Anbefalte egenskaper [[Kvalitetsmerknad_anbefalte_egenskaper]]

===== Kvalitetsmerknad: er i kvalitetsdimensjon (dqv:inDimension) [[Kvalitetsmerknad_erIKvalitetsdimensjon]]
...
===== Kvalitetsmerknad: har tekstdel (oa:hasBody) [[Kvalitetsmerknad_harTekstdel]]
...
==== Valgfrie egenskaper [[Kvalitetsmerknad_valgfrie_egenskaper]]

===== Kvalitetsmerknad: har merknad (rdfs:comment) [[Kvalitetsmerknad_harMerknad]]
...
===== Kvalitetsmerknad: har mål (oa:hasTarget) [[Kvalitetsmerknad_harMål]]
...
=== Kvalitetsmåling (dqv:QualityMeasurement) [[Kvalitetsmåling_egenskaper]]

==== Obligatoriske egenskaper [[Kvalitetsmåling_obligatoriske_egenskaper]]

===== Kvalitetsmåling: er kvalitetsmåling av (dqv:isMeasurementOf) [[Kvalitetsmåling_erKvalitetsmålingAv]]
...
==== Anbefalte egenskaper [[Kvalitetsmåling_anbefalte_egenskaper]]

===== Kvalitetsmåling: har verdi (dqv:value) [[Kvalitetsmåling_harVerdi]]
...
|Multiplisitet|0..1
|Kravnivå|Anbefalt
|Eksempel | Se eksemplet under <<Kvalitetsmåling: er kvalitetsmåling av (dqv:isMeasurementOf)>>
|===

==== Valgfrie egenskaper [[Kvalitetsmåling_valgfrie_egenskaper]]

===== Kvalitetsmåling: har merknad (rdfs:comment) [[Kvalitetsmåling_harMerknad]]
