...
Egenskapene beskrevet her i denne spesifikasjonen, supplerer https://https://data.norge.no/specification/dcat-ap-no/#Datasett[egenskapene for Datasett beskrevet i DCAT-AP-NO].
