...
Egenskapene beskrevet her i denne spesifikasjonen, supplerer https://informasjonsforvaltning.github.io/dcat-ap-no/#Datasett[egenskapene for Datasett beskrevet i DCAT-AP-NO].
